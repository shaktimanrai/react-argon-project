                    ...
                    <Row>
                      <div className="col">
                        ...
                        {props.count?.isLoading ? (
                          ...
                          <span className="h2 font-weight-bold mb-0">
                            {props.count?.count?.invoice_count}
                          </span>
                        )}
                      </div>
                      <Col className="col-auto">
                    ...
                    <Row>
                      <div className="col">
                        ...
                        {props.count?.isLoading ? (
                          ...
                          <span className="h2 font-weight-bold mb-0">
                            {props.count?.count?.open_project_count}
                          </span>
                        )}
                      </div>
                      <Col className="col-auto">
                    ...
                    <Row>
                      <div className="col">
                        <CardTitle
                          ...
                          className="text-uppercase text-muted mb-0"
                        >
                          Out Standing Recievable
                        </CardTitle>
                        {props.count?.isLoading ? (
                          <CircularLoader />
                        ) : (
                          <span className="h2 font-weight-bold mb-0">
                            {props.count?.count?.outstanding_receivable}
                          </span>
                        )}
                      </div>
                      <Col className="col-auto">
