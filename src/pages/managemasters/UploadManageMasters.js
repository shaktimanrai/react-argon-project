...
function UploadManageMasters(props) {
  let data = {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadManageMasters(data, user, toggle, setSubmitting);
    return;
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadManageMasters: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadManageMasters(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadManageMasters);
