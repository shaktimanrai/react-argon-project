...
function UploadManageDocuments(props) {
  let data = {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadManageDocuments(data, user, toggle, setSubmitting);
    return;
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadManageDocuments: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadManageDocuments(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadManageDocuments);
