...
function UploadManageNotifications(props) {
  let data = {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadManageNotifications(data, user, toggle, setSubmitting);
    return;
  };
    ...
    <div>
      ...
      <Modal className="modal-md" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle} className="d-flex align-items-center">
          Upload ManageNotifications Data
        </ModalHeader>
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadManageNotifications: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadManageNotifications(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadManageNotifications);
