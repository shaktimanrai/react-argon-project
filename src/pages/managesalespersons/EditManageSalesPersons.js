...
function EditManageSalesPersons(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.updateManageSalesPersonsData(data, user, toggle, setSubmitting);
    return;
  };
  ...
  return (
    <div>
      ...
      {deleteStatus && (
        <DeleteButton
          id={props.data?.id}
          deleteFunction={() => props.onDeleteManageSalesPersons(props.data?.id, data)}
        />
      )}

      <Modal className="modal-md" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle} className="d-flex align-items-center">
          Edit ManageSalesPersons
        </ModalHeader>
        {props.managesalespersons.isUpdateLoading && <LinerLoader />}
        <ModalBody className="">
          <Formik
            initialValues={{
...
const mapStateToProps = (state) => {
  return {
    managesalespersons: state.entities.managesalespersons,
    login: state.login,
  };
};
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onDeleteManageSalesPersons: (id, data) => dispatch(actions.deleteManageSalesPersons(id, data)),
...
export default connect(mapStateToProps, mapDispatchToProps)(EditManageSalesPersons);
