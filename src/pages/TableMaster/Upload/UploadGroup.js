...
function UploadGroup(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadGroup(data, user, toggle, setSubmitting);
    return;
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadGroup: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadGroup(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadGroup);
