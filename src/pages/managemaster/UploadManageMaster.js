...
function UploadManageMaster(props) {
  let data = {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadManageMaster(data, user, toggle, setSubmitting);
    return;
  };
    ...
    <div>
      ...
      <Modal className="modal-md" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle} className="d-flex align-items-center">
          Upload ManageMaster Master Data
        </ModalHeader>
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadManageMaster: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadManageMaster(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadManageMaster);
