...
function UploadSide(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadSide(data, user, toggle, setSubmitting);
    return;
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadSide: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadSide(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadSide);
