...
function UploadManageCommunication(props) {
  let data = {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.uploadManageCommunication(data, user, toggle, setSubmitting);
    return;
  };
    ...
    <div>
      ...
      <Modal className="modal-md" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle} className="d-flex align-items-center">
          Upload ManageCommunication Data
        </ModalHeader>
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadManageCommunication: (data, user, toggle, setSubmitting) =>
      dispatch(actions.uploadManageCommunication(data, user, toggle, setSubmitting)),
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(UploadManageCommunication);
